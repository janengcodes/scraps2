...
#                 print(json_string)
#                 json_string = model.generate_content("Please add a two new keys called 'measurements' and 'ingredients_list' to this existing json: " + json_string +" The measurement list should contain the numerical amount of each respective ingredient. then based on the list of ingredients, add two keys 'seasons' and 'food_groups' that classifies each ingredient into a food group: protein, produce, grains, dairy and each ingredient into a season: summer, spring, fall, winter")
#                 # jsonify in api 
...
#                 # food_groups_and_seasons = model.generate_content("based on this list of ingredients, " + str(data_dict["ingredients_list"]) + " give me a JSON object that classifies each ingredient into a food group 'protein', 'produce', 'grains', 'dairy' where the key is 'food_group' and each ingredient into a season 'summer', 'spring', 'fall', 'winter' where the key is 'season'.")
#                 # jsonify
#                 # print("food groups", food_groups_and_seasons.text)
#                 # food_groups_and_seasons_json = json.loads(food_groups_and_seasons.text)
#                 # print("seasons", seasons.text)")
                
#                 # food_groups_json = json.loads(food_groups.text)
#                 # seasons = model.generate_content("based on this list of ingredients, " + str(data_dict["ingredients_list"]) + " give me a JSON object that classifies each ingredient into a season 'summer', 'spring', 'fall', 'winter'. the key is 'season'.")
#                 # print("seasons", seasons.text)
#                 # seasons_json = json.loads(seasons.text)
#                 # print("dict")
#                 # print(data_dict)
...
#         'json': json_data,
#         'output': output,
#         'food_groups': data_dict['food_group'],
